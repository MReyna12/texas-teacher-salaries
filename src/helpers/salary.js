const districtSalaries = {
  addSalaries: (schoolDistrictData) => {
    ...
    const years = jsonData.data.austin_metro[1].school_year[1]["2022-2023"].yoe;
    //years.forEach((year) => console.log(Object.keys(year)));
    //console.log(years);
    const degreeNames = Object.keys(
      jsonData.data.austin_metro[1].school_year[1]["2022-2023"].yoe[0][0]
    );
...
export default districtSalaries;
